...
running global service (discovered via `~/.cyard/mba/service.json`).
...
| `CYARD_MBA_SERVICE_URL` | Explicit service base URL (skips discovery) | — |
| `CYARD_MBA_BASE_DIR` | Base dir for service discovery file | `~/.cyard` |
