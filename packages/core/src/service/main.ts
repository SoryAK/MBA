 ...
 *
 * Env:
 *   MBA_BASE_DIR   — store base dir (default `~/.mba`)
 *   LEGACY_MBA_LEGACY_TCB — per-project TCB path to migrate from on first boot
...
const legacyTcbPath = process.env.LEGACY_MBA_LEGACY_TCB;
