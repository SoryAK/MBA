/**
 * Persistent server state tracking via .legacy-store/server-state.json
 *
...
/**
 * Persisted server state. Written to .legacy-store/server-state.json after boot.
 */
...
/**
 * Load the last-known server state from .legacy-store/server-state.json
 *
...
/**
 * Save the new server state to .legacy-store/server-state.json
 *
