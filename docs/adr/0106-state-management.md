...
- **Status:** Proposed — mop exists (`compact` / `reasoning`, `sanitize` / `phase`). SM v1 is the next build step (see [ADR-0105](0105-context-management-and-ampi.md) order)
- **Date:** 2026-09-08
...
4. **Then** SM v1 (two sandboxes + door)
5. Assist → Recover → Sanction → ADR-0104
