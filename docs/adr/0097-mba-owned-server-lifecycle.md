...
- The boot script was a the original project artifact; MBA's "standalone framework" goal
...
**the original project boot script retirement.** The now-dead `mba/` cluster
